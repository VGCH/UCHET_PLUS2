## Проект устройства для интеграции счетчиков воды в системы умного дома
...
Если данный проект был вам полезен, то вы можете задонатить разработчику на оборудование. 

[Ссылка на донат](https://dalink.to/cyberex_tech)
